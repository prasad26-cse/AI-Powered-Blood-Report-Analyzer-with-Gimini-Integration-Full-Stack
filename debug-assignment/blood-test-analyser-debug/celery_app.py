    ...
    try:
        ...
        try:
            ...
            if GEMINI_API_KEY:
                ...
                result = enhanced_enhanced_enhanced_enhanced_enhanced_enhanced_enhanced_simple_blood_analysis(str(report.file_path), query_text)
        ...
        return {
            'status': 'completed',
            'result': result.get("result", "No analysis result was generated."),
            'processing_time': processing_time,
            'report_id': report_id
        }
